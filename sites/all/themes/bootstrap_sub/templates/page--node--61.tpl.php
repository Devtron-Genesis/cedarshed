...
?>
 ...
 <div class="content_site">
        <div class="sliders">
	          	<?php $image = '/images/bg_contact.png';?>
				<div class="item"> <img src="<?php echo $image?>" style="width:100%" alt="First slide">
                <div class="container">
                  <div class="carousel-caption">
                   <h3>We offer the full range of sheds, garden buildings, and workshops.</h3>
                   <p>Get in touch to talk about a personalised solution for your outdoor building.</p>
                  </div>
            </div>
          </div>
        </div><!--  end.slider -->
