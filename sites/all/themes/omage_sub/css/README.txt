...
To use these stylesheets, rename the files and omage_sub with the name of your theme.
...
omage_sub-alpha-default-narrow.css  
...
omage_sub-alpha-default-normal.css
...
omage_sub-alpha-default-wide.css
